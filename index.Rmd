...
header-includes:
  ...
  - \pretitle{\begin{center}
    \includegraphics[width=2in,height=2in]{images/logo.png}\LARGE\\}
...
link-citations: true
link-as-notes: true
description: "The second book in the Data Analysis series. Where the first book focuses on interpretation and causal inference, this book focuses on prediction models in machine learning, both supervised and unsupervised."
github-repo: mikenguyen13/advanced_data_analysis
