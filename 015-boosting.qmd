...
```{r fig-boosting-boston-pdp, fig.cap="Partial dependence of predicted median house value on the average number of rooms (rm) and on the percentage of lower-status population (lstat) for the gbm Boston model."}
