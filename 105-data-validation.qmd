...
A report table is precise, but when you are scanning a pipeline at 2 a.m. a chart makes a spike obvious at a glance in a way a column of numbers does not. The next chunk plots the fail percentage of every check on the corrupted data, coloring failures red so they jump out. Figure @fig-data-validation-fail-rates shows the result: every defect we injected appears as a red bar, while the checks that passed sit flat at zero in grey.
