...
@fig-cicd-reproducibility-gate-distribution shows the resulting spread of holdout AUC and where the threshold cuts it.
...
Having walked the chain end to end, it helps to see all the practices side by side. @tbl-cicd-reproducibility-practices summarizes which dial each one pins, what tool implements it, when it runs, and the specific failure it heads off.
