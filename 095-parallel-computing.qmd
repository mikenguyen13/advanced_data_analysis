...
::: {.callout-note}
An older walkthrough by Business Science^[<https://www.business-science.io/code-tools/2016/12/18/multidplyr.html#figure1>] is no longer available; the examples below follow the package author's current interface.
:::
