...
<!--chapter:end:01-1-part-machine-learning.Rmd-->
...
<!--chapter:end:07-gaussian-process-reg.Rmd-->

# (PART) TREE BASED {-}

<!--chapter:end:07.1-tree-based-part.Rmd-->
...
-   Regression trees can usulaly lead ot over-fitting ont he test set, to reduce this problem, we can prune (i.e., remove leaves) to obtain a **subtree** using cross-validation.

### Cost complexity pruning

-   laso knwon as **weakest link pruning**
...
<!--chapter:end:08-regression-trees.Rmd-->
...
2.  For $m = 1$ to M
    ...
    1.  Fit a clisifer $G_m(x)$ to the training data with weights $w_i$
...
<!--chapter:end:11-boosting.Rmd-->

# (PART) UNSUPERVISED LEARNING {-}

<!--chapter:end:13.1-part-unsupervised.Rmd-->

# (PART) REINFORCEMENT LEARNING {-}

<!--chapter:end:15.1-part-reinforcement.Rmd-->
...
<!--chapter:end:19-interpretable-machine-learning.Rmd-->

# (PART) DEEP LEARNING {-}

<!--chapter:end:19.1-part-deep-learning.Rmd-->

# (PART) SUPERVISED LEARNING {-}

<!--chapter:end:2.1-part-supervise-learning.Rmd-->
...
## Step 1: A set of function {#step-1-a-set-of-function}
...
<br> New problem domains for R:

-   Computer vision\
-   Computer speech recognition\
-   Reinforcement learning applications

<br> How do we train deep learning models?
...
<br> Statistics: Often focused on inferring the process by which data is generated Machine Learning: Principally focused on predicting future data

<br> Deep learning frontiers
...
\* tensorflow: Low *level interface to the TensorFlow computational graph.* tfdatasets: Scalable input pipelines for TensorFlow models.
...
Example of [Image classificaiton](https://blogs.rstudio.com/ai/posts/2017%20*12%20*14%20*image%20*classification%20*on%20*small%20*datasets/)
...
<!--chapter:end:20-deep-learning.Rmd-->
...
<!--chapter:end:21-application.Rmd-->
...
<!--chapter:end:29-research-methods.Rmd-->
...
<!--chapter:end:32-data-storage.Rmd-->
