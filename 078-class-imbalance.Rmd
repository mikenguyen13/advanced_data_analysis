...
A case weight lets an individual observation carry more or less emphasis during the model training phase, so that the algorithm tries harder to get the heavily weighted observations right. Many modeling procedures accept case weights directly, including boosting (see Chapter \@ref(boosting)). The natural move for imbalance is to give the minority-class observations larger weights, so that errors on them count for more when the model is fit.
