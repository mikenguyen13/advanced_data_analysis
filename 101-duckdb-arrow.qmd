# In-Process Analytics with DuckDB and Arrow {#sec-duckdb-arrow}
...
- Genuinely distributed data across many machines, with terabytes that exceed one node, is the place for Spark (`sparklyr`; see @sec-spark-sparklyr) or a warehouse, not a single-process engine.
