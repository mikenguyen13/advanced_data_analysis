...
- LIME. A method for explaining individual predictions in human-readable terms, covered in detail in Chapter \@ref(interpretable-machine-learning). When you can see *why* a model made a particular call, biased reasoning becomes much easier to spot.
