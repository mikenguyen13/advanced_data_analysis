...
= \mathbb{E}\!\left[\frac{1}{p_t^{2}}\,\Big|\,\pi(x_t)=a_t\right]\Pr(\pi(x_t)=a_t),
$$
...
## LinUCB and Regret in R: A Worked Example {#sec-cb-linucb-worked}
